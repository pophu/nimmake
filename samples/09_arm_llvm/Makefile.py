from pymakex.datasets import CORTEX_M4_ARMLLVM_CFG
from pymakex.Helper import BuildType, Helper
...
ToolChain_clang = {"TOOLPATH": toolpath_armllvm, "TOOL": "clang", "TOOL_PREFIX": ""}
ToolChain_riscv = {"TOOLPATH": toolpath_riscv, "TOOL": "gcc", "TOOL_PREFIX": "riscv-unknown-elf-"}
...
# ACTION COMMAND
############
CFG = CORTEX_M4_ARMLLVM_CFG.clone()
